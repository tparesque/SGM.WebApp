var URL_API = "http://localhost:5003";
...
} else if (location.hostname === "http://sgm-load-balancer-386166249.us-east-1.elb.amazonaws.com") {
...
var atualizarNome = function (nome) {
...
var redirectToPageByRole = function () {
    window.location.replace(URL_SITE + "/Home/Index");
};
